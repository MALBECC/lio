...
c
c     (LINPACK dppco = LAPACK dlansy+dpptrf+dppcon) factors a double precision symmetric positive definite
...
c
c     LINPACK dppdi = LAPACK dpptri computes the determinant and inverse
...
c
c     LINPACK dppsl = LAPACK dpptrs solves the double precision symmetric positive definite
c     system a * x = b
c     using the factors computed by dppco or dppfa.
c
c     on entry
