...
if (PKG_CONFIG_FOUND)
    ...
    find_path(LIBINT2_INCLUDE_DIR
        NAMES libint2.h
        PATHS "$ENV{LIBINT_HOME}/include"
        HINT ENV $ENV{LIBINT_HOME}
        PATH_SUFFIXES libint2
    )
    find_library(LIBINT2_LIBRARY 
        NAMES ${_LIBINT2_LIB_NAMES} 
        PATHS "$ENV{LIBINT_HOME}/lib" "$ENV{LIBINT_HOME}/lib64" 
        HINT ENV $ENV{LIBINT_HOME}
    )

    message(STATUS "LIBINT_HOME env var: $ENV{LIBINT_HOME}")
    message(STATUS "libint2 include dir: ${LIBINT2_INCLUDE_DIR}")
    message(STATUS "libint2 library dir: ${LIBINT2_LIBRARY}")
    message(STATUS "libint2 version: ${LIBINT2_VERSION}")
    message(STATUS "libint2 found: ${LIBINT2_FOUND}")
