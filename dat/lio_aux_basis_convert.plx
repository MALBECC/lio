...
# This script converts from the auxiliary basis set file format
# found, for instance, in the DZVP basis (not sure if it's an
# actual official format or not...) to the format expected by lio
#
# Usage: lio_aux_basis_convert.plx <aux basis file>
# The lio basis file is written to stdout
