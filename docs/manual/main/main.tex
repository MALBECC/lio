...
%references
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage[doi=false,isbn=false,url=false,eprint=false,sorting=none, citestyle=numeric-comp, backend=biber, refsegment=chapter, defernumbers=true]{biblatex}
