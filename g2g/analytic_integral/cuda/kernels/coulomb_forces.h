...
__global__ void gpu_coulomb_forces( uint num_terms, G2G::vec_type<scalar_type,2>* ac_values, uint* func2nuc, scalar_type* dens_values, uint* func_code, uint* local_dens,
                                    G2G::vec_type<scalar_type,3>* qm_forces, uint global_stride, G2G::vec_type<scalar_type,2>* ac_values_dens, G2G::vec_type<scalar_type,3>* nuc_pos_dens,
