{
  scalar_type F_mT[5];
  {
    ...
    lio_gamma<scalar_type, 4>(F_mT, T,gammaArray);
  }
  {
        ...
        // START INDEX i3=0, CENTER 2
        {
          ...
          // START INDEX i4=0, CENTER 2
          {
            ...
            my_fock[0] += (double)(preterm * fit_dens_sh[j + 0] *
                                   prefactor_dens * d12d34s_0);
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[0] * prefactor_dens * d12d34s_0);
#endif
          }
        }
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[1] * prefactor_dens * d12d34s_0);
#endif
          }
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[2] * prefactor_dens * d12d34s_0);
#endif
          }
        }
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[3] * prefactor_dens * d12d34s_0);
#endif
          }
          // START INDEX i4=1, CENTER 2
          {
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[4] * prefactor_dens * d12d34s_0);
#endif
          }
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[5] * prefactor_dens * d12d34s_0);
#endif
          }
        }
      }
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[6] * prefactor_dens * d12d34s_0);
#endif
          }
        }
        // START INDEX i3=1, CENTER 2
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[7] * prefactor_dens * d12d34s_0);
#endif
          }
          // START INDEX i4=1, CENTER 2
          {
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[8] * prefactor_dens * d12d34s_0);
#endif
          }
        }
        // START INDEX i3=2, CENTER 2
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[9] * prefactor_dens * d12d34s_0);
#endif
          }
          // START INDEX i4=1, CENTER 2
          {
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[10] * prefactor_dens * d12d34s_0);
#endif
          }
          // START INDEX i4=2, CENTER 2
          {
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[11] * prefactor_dens * d12d34s_0);
#endif
          }
        }
      }
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[12] * prefactor_dens * d12d34s_0);
#endif
          }
        }
        // START INDEX i3=1, CENTER 2
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[13] * prefactor_dens * d12d34s_0);
#endif
          }
          // START INDEX i4=1, CENTER 2
          {
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[14] * prefactor_dens * d12d34s_0);
#endif
          }
        }
        // START INDEX i3=2, CENTER 2
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[15] * prefactor_dens * d12d34s_0);
#endif
          }
          // START INDEX i4=1, CENTER 2
          {
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[16] * prefactor_dens * d12d34s_0);
#endif
          }
          // START INDEX i4=2, CENTER 2
          {
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[17] * prefactor_dens * d12d34s_0);
#endif
          }
        }
      }
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[18] * prefactor_dens * d12d34s_0);
#endif
          }
        }
        // START INDEX i3=1, CENTER 2
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[19] * prefactor_dens * d12d34s_0);
#endif
          }
          // START INDEX i4=1, CENTER 2
          {
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[20] * prefactor_dens * d12d34s_0);
#endif
          }
        }
        // START INDEX i3=2, CENTER 2
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[21] * prefactor_dens * d12d34s_0);
#endif
          }
          // START INDEX i4=1, CENTER 2
          {
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[22] * prefactor_dens * d12d34s_0);
#endif
          }
          // START INDEX i4=2, CENTER 2
          {
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[23] * prefactor_dens * d12d34s_0);
#endif
          }
        }
      }
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[24] * prefactor_dens * d12d34s_0);
#endif
          }
        }
        // START INDEX i3=1, CENTER 2
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[25] * prefactor_dens * d12d34s_0);
#endif
          }
          // START INDEX i4=1, CENTER 2
          {
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[26] * prefactor_dens * d12d34s_0);
#endif
          }
        }
        // START INDEX i3=2, CENTER 2
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[27] * prefactor_dens * d12d34s_0);
#endif
          }
          // START INDEX i4=1, CENTER 2
          {
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[28] * prefactor_dens * d12d34s_0);
#endif
          }
          // START INDEX i4=2, CENTER 2
          {
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[29] * prefactor_dens * d12d34s_0);
#endif
          }
        }
      }
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[30] * prefactor_dens * d12d34s_0);
#endif
          }
        }
        // START INDEX i3=1, CENTER 2
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[31] * prefactor_dens * d12d34s_0);
#endif
          }
          // START INDEX i4=1, CENTER 2
          {
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[32] * prefactor_dens * d12d34s_0);
#endif
          }
        }
        // START INDEX i3=2, CENTER 2
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[33] * prefactor_dens * d12d34s_0);
#endif
          }
          // START INDEX i4=1, CENTER 2
          {
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[34] * prefactor_dens * d12d34s_0);
#endif
          }
          // START INDEX i4=2, CENTER 2
          {
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[35] * prefactor_dens * d12d34s_0);
#endif
          }
        }
      }
