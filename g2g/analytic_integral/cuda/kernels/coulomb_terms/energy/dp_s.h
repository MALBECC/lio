{
  scalar_type F_mT[4];
  {
    ...
    lio_gamma<scalar_type, 3>(F_mT, T,gammaArray);
  }
  {
...
#else
          rc_sh[0][tid] +=
              (double)(preterm * dens[0] * prefactor_dens * d12p3s_0);
#endif
        }
...
#else
          rc_sh[0][tid] +=
              (double)(preterm * dens[1] * prefactor_dens * d12p3s_0);
#endif
        }
...
#else
          rc_sh[0][tid] +=
              (double)(preterm * dens[2] * prefactor_dens * d12p3s_0);
#endif
        }
      }
    }
    // START INDEX i1=1, CENTER 1
    {
...
#else
          rc_sh[0][tid] +=
              (double)(preterm * dens[3] * prefactor_dens * d12p3s_0);
#endif
        }
        // START INDEX i3=1, CENTER 2
        {
...
#else
          rc_sh[0][tid] +=
              (double)(preterm * dens[4] * prefactor_dens * d12p3s_0);
#endif
        }
        // START INDEX i3=2, CENTER 2
        {
...
#else
          rc_sh[0][tid] +=
              (double)(preterm * dens[5] * prefactor_dens * d12p3s_0);
#endif
        }
      }
      // START INDEX i2=1, CENTER 1
      {
        ...
        // START INDEX i3=0, CENTER 2
        {
          ...
          scalar_type preterm = norm2;
#ifdef FOCK_CALC
          my_fock[6] += (double)(preterm * fit_dens_sh[j + 0] * prefactor_dens *
                                 d12p3s_0);
#else
          rc_sh[0][tid] +=
              (double)(preterm * dens[6] * prefactor_dens * d12p3s_0);
#endif
        }
        // START INDEX i3=1, CENTER 2
        {
          ...
          scalar_type preterm = norm2;
#ifdef FOCK_CALC
          my_fock[7] += (double)(preterm * fit_dens_sh[j + 0] * prefactor_dens *
                                 d12p3s_0);
#else
          rc_sh[0][tid] +=
              (double)(preterm * dens[7] * prefactor_dens * d12p3s_0);
#endif
        }
        // START INDEX i3=2, CENTER 2
        {
          ...
          scalar_type preterm = norm2;
#ifdef FOCK_CALC
          my_fock[8] += (double)(preterm * fit_dens_sh[j + 0] * prefactor_dens *
                                 d12p3s_0);
#else
          rc_sh[0][tid] +=
              (double)(preterm * dens[8] * prefactor_dens * d12p3s_0);
#endif
        }
      }
    }
    // START INDEX i1=2, CENTER 1
    {
      ...
      // START INDEX i2=0, CENTER 1
      {
        ...
        // START INDEX i3=0, CENTER 2
        {
          ...
          scalar_type preterm = norm2;
#ifdef FOCK_CALC
          my_fock[9] += (double)(preterm * fit_dens_sh[j + 0] * prefactor_dens *
                                 d12p3s_0);
#else
          rc_sh[0][tid] +=
              (double)(preterm * dens[9] * prefactor_dens * d12p3s_0);
#endif
        }
        // START INDEX i3=1, CENTER 2
        {
          ...
          my_fock[10] += (double)(preterm * fit_dens_sh[j + 0] *
                                  prefactor_dens * d12p3s_0);
#else
          rc_sh[0][tid] +=
              (double)(preterm * dens[10] * prefactor_dens * d12p3s_0);
#endif
        }
        // START INDEX i3=2, CENTER 2
        {
...
#else
          rc_sh[0][tid] +=
              (double)(preterm * dens[11] * prefactor_dens * d12p3s_0);
#endif
        }
      }
      // START INDEX i2=1, CENTER 1
...
#else
          rc_sh[0][tid] +=
              (double)(preterm * dens[12] * prefactor_dens * d12p3s_0);
#endif
        }
        // START INDEX i3=1, CENTER 2
        {
...
#else
          rc_sh[0][tid] +=
              (double)(preterm * dens[13] * prefactor_dens * d12p3s_0);
#endif
        }
        // START INDEX i3=2, CENTER 2
        {
...
#else
          rc_sh[0][tid] +=
              (double)(preterm * dens[14] * prefactor_dens * d12p3s_0);
#endif
        }
      }
...
#else
          rc_sh[0][tid] +=
              (double)(preterm * dens[15] * prefactor_dens * d12p3s_0);
#endif
        }
        // START INDEX i3=1, CENTER 2
        {
...
#else
          rc_sh[0][tid] +=
              (double)(preterm * dens[16] * prefactor_dens * d12p3s_0);
#endif
        }
        // START INDEX i3=2, CENTER 2
        {
...
#else
          rc_sh[0][tid] +=
              (double)(preterm * dens[17] * prefactor_dens * d12p3s_0);
#endif
        }
      }
    }
