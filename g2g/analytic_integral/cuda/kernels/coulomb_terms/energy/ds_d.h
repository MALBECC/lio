        ...
        // START INDEX i3=0, CENTER 3
        {
          ...
          // START INDEX i4=0, CENTER 3
          {
            ...
            my_fock[0] += (double)(preterm * fit_dens_sh[j + 0] *
                                   prefactor_dens * d12sd34_0);
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[0] * prefactor_dens * d12sd34_0);
#endif
          }
        }
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[1] * prefactor_dens * d12sd34_0);
#endif
          }
        }
        // START INDEX i3=1, CENTER 3
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[2] * prefactor_dens * d12sd34_0);
#endif
          }
        }
        // START INDEX i3=1, CENTER 3
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[3] * prefactor_dens * d12sd34_0);
#endif
          }
        }
        // START INDEX i3=1, CENTER 3
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[4] * prefactor_dens * d12sd34_0);
#endif
          }
        }
        // START INDEX i3=1, CENTER 3
...
#else
            rc_sh[0][tid] +=
                (double)(preterm * dens[5] * prefactor_dens * d12sd34_0);
#endif
          }
        }
        // START INDEX i3=1, CENTER 3
