    ...
    //START INDEX i1=0, CENTER 1
    {
...
#ifdef FOCK_CALC
          my_fock[0] += (double)( fit_dens_sh[j+0] * prefactor_dens *  p1p2p3_0 );
#else
...
#ifdef FOCK_CALC
          my_fock[0] += (double)( fit_dens_sh[j+1] * prefactor_dens *  p1p2p3_0 );
#else
...
#ifdef FOCK_CALC
          my_fock[0] += (double)( fit_dens_sh[j+2] * prefactor_dens *  p1p2p3_0 );
#else
      ...
      //START INDEX i2=1, CENTER 2
      {
        ...
        //START INDEX i3=0, CENTER 3
        {
          ...
          p1p2p3_0 += inv_two_zeta_eta * sp2s_1;
#ifdef FOCK_CALC
          my_fock[1] += (double)( fit_dens_sh[j+0] * prefactor_dens *  p1p2p3_0 );
#else
        ...
        //START INDEX i3=1, CENTER 3
        {
          ...
          p1p2p3_0 += inv_two_zeta_eta * p1ss_1;
#ifdef FOCK_CALC
          my_fock[1] += (double)( fit_dens_sh[j+1] * prefactor_dens *  p1p2p3_0 );
#else
        ...
        //START INDEX i3=2, CENTER 3
        {
          scalar_type p1p2p3_0 = WmQ[2] * p1p2s_1;
#ifdef FOCK_CALC
          my_fock[1] += (double)( fit_dens_sh[j+2] * prefactor_dens *  p1p2p3_0 );
#else
      ...
      //START INDEX i2=2, CENTER 2
      {
        ...
        //START INDEX i3=0, CENTER 3
        {
          ...
          p1p2p3_0 += inv_two_zeta_eta * sp2s_1;
#ifdef FOCK_CALC
          my_fock[2] += (double)( fit_dens_sh[j+0] * prefactor_dens *  p1p2p3_0 );
#else
        ...
        //START INDEX i3=1, CENTER 3
        {
          scalar_type p1p2p3_0 = WmQ[1] * p1p2s_1;
#ifdef FOCK_CALC
          my_fock[2] += (double)( fit_dens_sh[j+1] * prefactor_dens *  p1p2p3_0 );
#else
        ...
        //START INDEX i3=2, CENTER 3
        {
          ...
          p1p2p3_0 += inv_two_zeta_eta * p1ss_1;
#ifdef FOCK_CALC
          my_fock[2] += (double)( fit_dens_sh[j+2] * prefactor_dens *  p1p2p3_0 );
#else
    ...
    //START INDEX i1=1, CENTER 1
    {
      ...
      //START INDEX i2=0, CENTER 2
      {
        ...
        //START INDEX i3=0, CENTER 3
        {
          ...
          p1p2p3_0 += inv_two_zeta_eta * p1ss_1;
#ifdef FOCK_CALC
          my_fock[3] += (double)( fit_dens_sh[j+0] * prefactor_dens *  p1p2p3_0 );
#else
        ...
        //START INDEX i3=1, CENTER 3
        {
          ...
          p1p2p3_0 += inv_two_zeta_eta * sp2s_1;
#ifdef FOCK_CALC
          my_fock[3] += (double)( fit_dens_sh[j+1] * prefactor_dens *  p1p2p3_0 );
#else
        ...
        //START INDEX i3=2, CENTER 3
        {
          scalar_type p1p2p3_0 = WmQ[2] * p1p2s_1;
#ifdef FOCK_CALC
          my_fock[3] += (double)( fit_dens_sh[j+2] * prefactor_dens *  p1p2p3_0 );
#else
      ...
      //START INDEX i2=1, CENTER 2
      {
        ...
        //START INDEX i3=0, CENTER 3
        {
          scalar_type p1p2p3_0 = WmQ[0] * p1p2s_1;
#ifdef FOCK_CALC
          my_fock[4] += (double)( fit_dens_sh[j+0] * prefactor_dens *  p1p2p3_0 );
#else
        ...
        //START INDEX i3=1, CENTER 3
        {
          ...
          p1p2p3_0 += inv_two_zeta_eta * p1ss_1;
#ifdef FOCK_CALC
          my_fock[4] += (double)( fit_dens_sh[j+1] * prefactor_dens *  p1p2p3_0 );
#else
        ...
        //START INDEX i3=2, CENTER 3
        {
          scalar_type p1p2p3_0 = WmQ[2] * p1p2s_1;
#ifdef FOCK_CALC
          my_fock[4] += (double)( fit_dens_sh[j+2] * prefactor_dens *  p1p2p3_0 );
#else
      ...
      //START INDEX i2=2, CENTER 2
      {
        ...
        //START INDEX i3=0, CENTER 3
        {
          scalar_type p1p2p3_0 = WmQ[0] * p1p2s_1;
#ifdef FOCK_CALC
          my_fock[5] += (double)( fit_dens_sh[j+0] * prefactor_dens *  p1p2p3_0 );
#else
        ...
        //START INDEX i3=1, CENTER 3
        {
          ...
          p1p2p3_0 += inv_two_zeta_eta * sp2s_1;
#ifdef FOCK_CALC
          my_fock[5] += (double)( fit_dens_sh[j+1] * prefactor_dens *  p1p2p3_0 );
#else
        ...
        //START INDEX i3=2, CENTER 3
        {
          ...
          p1p2p3_0 += inv_two_zeta_eta * p1ss_1;
#ifdef FOCK_CALC
          my_fock[5] += (double)( fit_dens_sh[j+2] * prefactor_dens *  p1p2p3_0 );
#else
    ...
    //START INDEX i1=2, CENTER 1
    {
      ...
      //START INDEX i2=0, CENTER 2
      {
        ...
        //START INDEX i3=0, CENTER 3
        {
          ...
          p1p2p3_0 += inv_two_zeta_eta * p1ss_1;
#ifdef FOCK_CALC
          my_fock[6] += (double)( fit_dens_sh[j+0] * prefactor_dens *  p1p2p3_0 );
#else
        ...
        //START INDEX i3=1, CENTER 3
        {
          scalar_type p1p2p3_0 = WmQ[1] * p1p2s_1;
#ifdef FOCK_CALC
          my_fock[6] += (double)( fit_dens_sh[j+1] * prefactor_dens *  p1p2p3_0 );
#else
        ...
        //START INDEX i3=2, CENTER 3
        {
          ...
          p1p2p3_0 += inv_two_zeta_eta * sp2s_1;
#ifdef FOCK_CALC
          my_fock[6] += (double)( fit_dens_sh[j+2] * prefactor_dens *  p1p2p3_0 );
#else
      ...
      //START INDEX i2=1, CENTER 2
      {
        ...
        //START INDEX i3=0, CENTER 3
        {
          scalar_type p1p2p3_0 = WmQ[0] * p1p2s_1;
#ifdef FOCK_CALC
          my_fock[7] += (double)( fit_dens_sh[j+0] * prefactor_dens *  p1p2p3_0 );
#else
        ...
        //START INDEX i3=1, CENTER 3
        {
          ...
          p1p2p3_0 += inv_two_zeta_eta * p1ss_1;
#ifdef FOCK_CALC
          my_fock[7] += (double)( fit_dens_sh[j+1] * prefactor_dens *  p1p2p3_0 );
#else
        ...
        //START INDEX i3=2, CENTER 3
        {
          ...
          p1p2p3_0 += inv_two_zeta_eta * sp2s_1;
#ifdef FOCK_CALC
          my_fock[7] += (double)( fit_dens_sh[j+2] * prefactor_dens *  p1p2p3_0 );
#else
      ...
      //START INDEX i2=2, CENTER 2
      {
        ...
        //START INDEX i3=0, CENTER 3
        {
          scalar_type p1p2p3_0 = WmQ[0] * p1p2s_1;
#ifdef FOCK_CALC
          my_fock[8] += (double)( fit_dens_sh[j+0] * prefactor_dens *  p1p2p3_0 );
#else
        ...
        //START INDEX i3=1, CENTER 3
        {
          scalar_type p1p2p3_0 = WmQ[1] * p1p2s_1;
#ifdef FOCK_CALC
          my_fock[8] += (double)( fit_dens_sh[j+1] * prefactor_dens *  p1p2p3_0 );
#else
        ...
        //START INDEX i3=2, CENTER 3
        {
          ...
          p1p2p3_0 += inv_two_zeta_eta * p1ss_1;
#ifdef FOCK_CALC
          my_fock[8] += (double)( fit_dens_sh[j+2] * prefactor_dens *  p1p2p3_0 );
#else
