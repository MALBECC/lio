    ...
    // START INDEX i1=0, CENTER 1
    {
...
#else
          rc_sh[0][tid] +=
              (double)(preterm * dens[0] * prefactor_dens * p1sd23_0);
#endif
        }
      }
      ...
      // START INDEX i2=2, CENTER 3
      {
        ...
        // START INDEX i3=0, CENTER 3
        {
          ...
          scalar_type preterm = norm3;
#ifdef FOCK_CALC
          my_fock[0] += (double)(preterm * fit_dens_sh[j + 3] * prefactor_dens *
                                 p1sd23_0);
#else
          rc_sh[3][tid] +=
              (double)(preterm * dens[0] * prefactor_dens * p1sd23_0);
        ...
        // START INDEX i3=1, CENTER 3
        {
          ...
          scalar_type preterm = norm3;
#ifdef FOCK_CALC
          my_fock[0] += (double)(preterm * fit_dens_sh[j + 4] * prefactor_dens *
                                 p1sd23_0);
#else
          rc_sh[4][tid] +=
              (double)(preterm * dens[0] * prefactor_dens * p1sd23_0);
        ...
        // START INDEX i3=2, CENTER 3
        {
          ...
          scalar_type preterm = norm3;
#ifdef FOCK_CALC
          my_fock[0] += (double)(preterm * fit_dens_sh[j + 5] * prefactor_dens *
                                 p1sd23_0);
#else
          rc_sh[5][tid] +=
              (double)(preterm * dens[0] * prefactor_dens * p1sd23_0);
    ...
    // START INDEX i1=1, CENTER 1
    {
...
#else
          rc_sh[0][tid] +=
              (double)(preterm * dens[1] * prefactor_dens * p1sd23_0);
#endif
        }
      }
      // START INDEX i2=1, CENTER 3
      ...
      // START INDEX i2=2, CENTER 3
      {
        ...
        // START INDEX i3=0, CENTER 3
        {
          ...
          scalar_type preterm = norm3;
#ifdef FOCK_CALC
          my_fock[1] += (double)(preterm * fit_dens_sh[j + 3] * prefactor_dens *
                                 p1sd23_0);
#else
          rc_sh[3][tid] +=
              (double)(preterm * dens[1] * prefactor_dens * p1sd23_0);
        ...
        // START INDEX i3=1, CENTER 3
        {
          ...
          scalar_type preterm = norm3;
#ifdef FOCK_CALC
          my_fock[1] += (double)(preterm * fit_dens_sh[j + 4] * prefactor_dens *
                                 p1sd23_0);
#else
          rc_sh[4][tid] +=
              (double)(preterm * dens[1] * prefactor_dens * p1sd23_0);
        ...
        // START INDEX i3=2, CENTER 3
        {
          ...
          scalar_type preterm = norm3;
#ifdef FOCK_CALC
          my_fock[1] += (double)(preterm * fit_dens_sh[j + 5] * prefactor_dens *
                                 p1sd23_0);
#else
          rc_sh[5][tid] +=
              (double)(preterm * dens[1] * prefactor_dens * p1sd23_0);
    ...
    // START INDEX i1=2, CENTER 1
    {
...
#else
          rc_sh[0][tid] +=
              (double)(preterm * dens[2] * prefactor_dens * p1sd23_0);
#endif
        }
      }
      // START INDEX i2=1, CENTER 3
      ...
      // START INDEX i2=2, CENTER 3
      {
        ...
        // START INDEX i3=0, CENTER 3
        {
          ...
          scalar_type preterm = norm3;
#ifdef FOCK_CALC
          my_fock[2] += (double)(preterm * fit_dens_sh[j + 3] * prefactor_dens *
                                 p1sd23_0);
#else
          rc_sh[3][tid] +=
              (double)(preterm * dens[2] * prefactor_dens * p1sd23_0);
        ...
        // START INDEX i3=1, CENTER 3
        {
          ...
          scalar_type preterm = norm3;
#ifdef FOCK_CALC
          my_fock[2] += (double)(preterm * fit_dens_sh[j + 4] * prefactor_dens *
                                 p1sd23_0);
#else
          rc_sh[4][tid] +=
              (double)(preterm * dens[2] * prefactor_dens * p1sd23_0);
        ...
        // START INDEX i3=2, CENTER 3
        {
          ...
          scalar_type preterm = norm3;
#ifdef FOCK_CALC
          my_fock[2] += (double)(preterm * fit_dens_sh[j + 5] * prefactor_dens *
                                 p1sd23_0);
#else
          rc_sh[5][tid] +=
              (double)(preterm * dens[2] * prefactor_dens * p1sd23_0);
