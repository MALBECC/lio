      ...
      // START INDEX i2=0, CENTER 1
      {
        ...
        // START INDEX i3=0, CENTER 2
        {
          ...
          // START INDEX i4=0, CENTER 2
          {
            ...
            scalar_type sd34s_1 = PmB[0] * sp3s_1 + WmP[0] * sp3s_2;
            scalar_type p2p4s_1 = PmB[0] * p2ss_1 + WmP[0] * p2ss_2;
            scalar_type sd34s_2 = PmB[0] * sp3s_2 + WmP[0] * sp3s_3;
            scalar_type p2p4s_2 = PmB[0] * p2ss_2 + WmP[0] * p2ss_3;
            scalar_type p1p4s_1 = PmB[0] * p1ss_1 + WmP[0] * p1ss_2;
            ...
            p1p4s_1 += inv_two_zeta * (F_mT[1] - rho_zeta * F_mT[2]);
            ...
            p2p4s_1 += inv_two_zeta * (F_mT[1] - rho_zeta * F_mT[2]);
            ...
            sd34s_1 += inv_two_zeta * (F_mT[1] - rho_zeta * F_mT[2]);
            ...
            // START INDEX i5=0, CENTER 3
            {
              ...
              scalar_type p2d34p5_0 = WmQ[0] * p2d34s_1;
              scalar_type p2d34p5_1 = WmQ[0] * p2d34s_2;
              scalar_type p1d34p5_0 = WmQ[0] * p1d34s_1;
              scalar_type p1d34p5_1 = WmQ[0] * p1d34s_2;
              scalar_type d12p4p5_0 = WmQ[0] * d12p4s_1;
              ...
              p1d34p5_0 += inv_two_zeta_eta * sd34s_1;
              p1d34p5_1 += inv_two_zeta_eta * sd34s_2;
              d12p4p5_0 += inv_two_zeta_eta * p2p4s_1;
              ...
              p2d34p5_0 += inv_two_zeta_eta * sd34s_1;
              p2d34p5_1 += inv_two_zeta_eta * sd34s_2;
              d12p4p5_0 += inv_two_zeta_eta * p1p4s_1;
              ...
              p2d34p5_0 += inv_two_zeta_eta * p2p4s_1;
              p2d34p5_1 += inv_two_zeta_eta * p2p4s_2;
              p1d34p5_0 += inv_two_zeta_eta * p1p4s_1;
              ...
              p2d34p5_0 += inv_two_zeta_eta * p2p3s_1;
              p2d34p5_1 += inv_two_zeta_eta * p2p3s_2;
              p1d34p5_0 += inv_two_zeta_eta * p1p3s_1;
              p1d34p5_1 += inv_two_zeta_eta * p1p3s_2;
              d12p4p5_0 += inv_two_zeta_eta * d12ss_1;
              d12p4p5_1 += inv_two_zeta_eta * d12ss_2;
              scalar_type preterm = norm2 * norm4;
              preterm *= fit_dens_sh[j + 0] * prefactor_dens * dens[0];
              // START INDEX igrad=0
              {
                scalar_type C_force_term = inv_two_zeta_eta * p2d34p5_1;
                C_force_term += inv_two_zeta_eta * p1d34p5_1;
                C_force_term += inv_two_zeta_eta * d12p4p5_1;
                C_force_term += inv_two_zeta_eta * d12p3p5_1;
                C_force_term += inv_two_eta * (d12d34s_0 - rho_eta * d12d34s_1);
                C_force_term += WmQ[0] * d12d34p5_1;
                scalar_type A_force_term =
                    inv_two_zeta * (p2d34p5_0 - rho_zeta * p2d34p5_1);
                A_force_term +=
                    inv_two_zeta * (p1d34p5_0 - rho_zeta * p1d34p5_1);
                A_force_term +=
                    inv_two_zeta * (d12p4p5_0 - rho_zeta * d12p4p5_1);
                A_force_term +=
                    inv_two_zeta * (d12p3p5_0 - rho_zeta * d12p3p5_1);
                A_force_term += inv_two_zeta_eta * d12d34s_1;
                A_force_term += WmP[0] * d12d34p5_1;
                scalar_type B_force_term = PmB[0] * d12d34p5_0 + A_force_term;
                A_force_term += PmA[0] * d12d34p5_0;
                A_force_term *= 2.0 * ai;
                B_force_term *= 2.0 * aj;
                C_force_term *= 2.0 * ac_val_dens_sh[j].x;
                A_force_term -= p2d34p5_0;
                A_force_term -= p1d34p5_0;
                B_force_term -= d12p4p5_0;
                B_force_term -= d12p3p5_0;
                C_force_term -= d12d34s_0;
              ...
              // START INDEX igrad=1
              {
                scalar_type C_force_term = WmQ[1] * d12d34p5_1;
                scalar_type A_force_term = WmP[1] * d12d34p5_1;
                scalar_type B_force_term = PmB[1] * d12d34p5_0 + A_force_term;
                A_force_term += PmA[1] * d12d34p5_0;
                A_force_term *= 2.0 * ai;
                B_force_term *= 2.0 * aj;
                C_force_term *= 2.0 * ac_val_dens_sh[j].x;
              ...
              // START INDEX igrad=2
              {
                scalar_type C_force_term = WmQ[2] * d12d34p5_1;
                scalar_type A_force_term = WmP[2] * d12d34p5_1;
                scalar_type B_force_term = PmB[2] * d12d34p5_0 + A_force_term;
                A_force_term += PmA[2] * d12d34p5_0;
                A_force_term *= 2.0 * ai;
                B_force_term *= 2.0 * aj;
                C_force_term *= 2.0 * ac_val_dens_sh[j].x;
            ...
            // START INDEX i5=1, CENTER 3
            {
              ...
              scalar_type p2d34p5_0 = WmQ[1] * p2d34s_1;
              scalar_type p2d34p5_1 = WmQ[1] * p2d34s_2;
              scalar_type p1d34p5_0 = WmQ[1] * p1d34s_1;
              scalar_type p1d34p5_1 = WmQ[1] * p1d34s_2;
              scalar_type d12p4p5_0 = WmQ[1] * d12p4s_1;
              ...
              // START INDEX igrad=1
              {
                scalar_type C_force_term =
                    inv_two_eta * (d12d34s_0 - rho_eta * d12d34s_1);
                C_force_term += WmQ[1] * d12d34p5_1;
                scalar_type A_force_term = inv_two_zeta_eta * d12d34s_1;
                A_force_term += WmP[1] * d12d34p5_1;
                scalar_type B_force_term = PmB[1] * d12d34p5_0 + A_force_term;
                A_force_term += PmA[1] * d12d34p5_0;
                A_force_term *= 2.0 * ai;
                B_force_term *= 2.0 * aj;
            ...
            // START INDEX i5=2, CENTER 3
            {
              ...
              scalar_type p2d34p5_0 = WmQ[2] * p2d34s_1;
              scalar_type p2d34p5_1 = WmQ[2] * p2d34s_2;
              scalar_type p1d34p5_0 = WmQ[2] * p1d34s_1;
              scalar_type p1d34p5_1 = WmQ[2] * p1d34s_2;
              scalar_type d12p4p5_0 = WmQ[2] * d12p4s_1;
              ...
              // START INDEX igrad=2
              {
                scalar_type C_force_term =
                    inv_two_eta * (d12d34s_0 - rho_eta * d12d34s_1);
                C_force_term += WmQ[2] * d12d34p5_1;
                scalar_type A_force_term = inv_two_zeta_eta * d12d34s_1;
                A_force_term += WmP[2] * d12d34p5_1;
                scalar_type B_force_term = PmB[2] * d12d34p5_0 + A_force_term;
                A_force_term += PmA[2] * d12d34p5_0;
                A_force_term *= 2.0 * ai;
                B_force_term *= 2.0 * aj;
        ...
        // START INDEX i3=1, CENTER 2
        {
          ...
          // START INDEX i4=0, CENTER 2
          {
            ...
            // START INDEX i5=0, CENTER 3
            {
              ...
              // START INDEX igrad=1
              {
                scalar_type C_force_term = inv_two_zeta_eta * d12p4p5_1;
                C_force_term += WmQ[1] * d12d34p5_1;
                scalar_type A_force_term =
                    inv_two_zeta * (d12p4p5_0 - rho_zeta * d12p4p5_1);
                A_force_term += WmP[1] * d12d34p5_1;
          ...
          // START INDEX i4=1, CENTER 2
          {
            ...
            scalar_type sd34s_1 = PmB[1] * sp3s_1 + WmP[1] * sp3s_2;
            scalar_type sd34s_2 = PmB[1] * sp3s_2 + WmP[1] * sp3s_3;
            scalar_type d12p4s_1 = PmB[1] * d12ss_1 + WmP[1] * d12ss_2;
            scalar_type p2p4s_1 = PmB[1] * p2ss_1 + WmP[1] * p2ss_2;
            scalar_type p1p4s_1 = PmB[1] * p1ss_1 + WmP[1] * p1ss_2;
        ...
        // START INDEX i3=2, CENTER 2
        {
          ...
          // START INDEX i4=1, CENTER 2
          {
            ...
            // START INDEX i5=0, CENTER 3
            {
              ...
              // START INDEX igrad=1
              {
                scalar_type C_force_term = inv_two_zeta_eta * d12p3p5_1;
                C_force_term += WmQ[1] * d12d34p5_1;
                scalar_type A_force_term =
                    inv_two_zeta * (d12p3p5_0 - rho_zeta * d12p3p5_1);
                A_force_term += WmP[1] * d12d34p5_1;
          ...
          // START INDEX i4=2, CENTER 2
          {
            ...
            scalar_type sd34s_1 = PmB[2] * sp3s_1 + WmP[2] * sp3s_2;
            scalar_type sd34s_2 = PmB[2] * sp3s_2 + WmP[2] * sp3s_3;
            scalar_type d12p4s_1 = PmB[2] * d12ss_1 + WmP[2] * d12ss_2;
            scalar_type p2p4s_1 = PmB[2] * p2ss_1 + WmP[2] * p2ss_2;
            scalar_type p1p4s_1 = PmB[2] * p1ss_1 + WmP[2] * p1ss_2;
        ...
        // START INDEX i3=0, CENTER 2
        {
          ...
          // START INDEX i4=0, CENTER 2
          {
            ...
            // START INDEX i5=0, CENTER 3
            {
              ...
              // START INDEX igrad=0
              {
                scalar_type C_force_term = inv_two_zeta_eta * p1d34p5_1;
                C_force_term += inv_two_zeta_eta * d12p4p5_1;
                C_force_term += inv_two_zeta_eta * d12p3p5_1;
                C_force_term += inv_two_eta * (d12d34s_0 - rho_eta * d12d34s_1);
                C_force_term += WmQ[0] * d12d34p5_1;
        ...
        // START INDEX i3=1, CENTER 2
        {
          ...
          // START INDEX i4=1, CENTER 2
          {
            ...
            // START INDEX i5=1, CENTER 3
            {
              ...
              // START INDEX igrad=0
              {
                scalar_type C_force_term = WmQ[0] * d12d34p5_1;
                scalar_type A_force_term = WmP[0] * d12d34p5_1;
                scalar_type B_force_term = PmB[0] * d12d34p5_0 + A_force_term;
                A_force_term += PmA[0] * d12d34p5_0;
                A_force_term *= 2.0 * ai;
                B_force_term *= 2.0 * aj;
