  ...
  }
  {
    //START INDEX i1=0, CENTER 1
    {
      ...
      //START INDEX i2=0, CENTER 1
      {
        ...
        //START INDEX igrad=0
        {
          scalar_type C_force_term = inv_two_zeta_eta * p2ss_1;
          C_force_term += inv_two_zeta_eta * p1ss_1;
          C_force_term += WmQ[0] * d12ss_1;
          scalar_type A_force_term = inv_two_zeta * (p2ss_0 - rho_zeta * p2ss_1);
          A_force_term += inv_two_zeta * (p1ss_0 - rho_zeta * p1ss_1);
          A_force_term += WmP[0] * d12ss_1;
          scalar_type B_force_term = PmB[0] * d12ss_0 + A_force_term;
          A_force_term += PmA[0] * d12ss_0;
        ...
        //START INDEX igrad=1
        {
          scalar_type C_force_term = WmQ[1] * d12ss_1;
          scalar_type A_force_term = WmP[1] * d12ss_1;
          scalar_type B_force_term = PmB[1] * d12ss_0 + A_force_term;
          A_force_term += PmA[1] * d12ss_0;
          A_force_term *= 2.0f * ai;
          B_force_term *= 2.0f * aj;
          C_force_term *= 2.0f * ac_val_dens_sh[j].x;
        ...
        //START INDEX igrad=2
        {
          scalar_type C_force_term = WmQ[2] * d12ss_1;
          scalar_type A_force_term = WmP[2] * d12ss_1;
          scalar_type B_force_term = PmB[2] * d12ss_0 + A_force_term;
          A_force_term += PmA[2] * d12ss_0;
          A_force_term *= 2.0f * ai;
          B_force_term *= 2.0f * aj;
          C_force_term *= 2.0f * ac_val_dens_sh[j].x;
    ...
    //START INDEX i1=1, CENTER 1
    {
      ...
      //START INDEX i2=0, CENTER 1
      {
        ...
        //START INDEX igrad=0
        {
          ...
          C_force_term += WmQ[0] * d12ss_1;
          scalar_type A_force_term = inv_two_zeta * (p1ss_0 - rho_zeta * p1ss_1);
          A_force_term += WmP[0] * d12ss_1;
          scalar_type B_force_term = PmB[0] * d12ss_0 + A_force_term;
          A_force_term += PmA[0] * d12ss_0;
          A_force_term *= 2.0f * ai;
        ...
        {
          scalar_type C_force_term = inv_two_zeta_eta * p2ss_1;
          C_force_term += WmQ[1] * d12ss_1;
          scalar_type A_force_term = inv_two_zeta * (p2ss_0 - rho_zeta * p2ss_1);
          A_force_term += WmP[1] * d12ss_1;
          scalar_type B_force_term = PmB[1] * d12ss_0 + A_force_term;
          A_force_term += PmA[1] * d12ss_0;
          A_force_term *= 2.0f * ai;
          B_force_term *= 2.0f * aj;
      ...
      //START INDEX i2=1, CENTER 1
      {
        ...
        //START INDEX igrad=0
        {
          scalar_type C_force_term = WmQ[0] * d12ss_1;
          scalar_type A_force_term = WmP[0] * d12ss_1;
          scalar_type B_force_term = PmB[0] * d12ss_0 + A_force_term;
          A_force_term += PmA[0] * d12ss_0;
          A_force_term *= 2.0f * ai;
          B_force_term *= 2.0f * aj;
    ...
    //START INDEX i1=2, CENTER 1
    {
      ...
      //START INDEX i2=0, CENTER 1
      {
        ...
        {
          scalar_type C_force_term = inv_two_zeta_eta * p2ss_1;
          C_force_term += WmQ[2] * d12ss_1;
          scalar_type A_force_term = inv_two_zeta * (p2ss_0 - rho_zeta * p2ss_1);
          A_force_term += WmP[2] * d12ss_1;
          scalar_type B_force_term = PmB[2] * d12ss_0 + A_force_term;
          A_force_term += PmA[2] * d12ss_0;
          A_force_term *= 2.0f * ai;
          B_force_term *= 2.0f * aj;
