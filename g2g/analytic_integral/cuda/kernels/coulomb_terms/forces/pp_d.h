      ...
      //START INDEX i2=0, CENTER 2
      {
        ...
        //START INDEX i3=0, CENTER 3
        {
          ...
          //START INDEX i4=0, CENTER 3
          {
            ...
            //START INDEX igrad=0
            {
              ...
              scalar_type A_force_term = inv_two_zeta * (sp2d34_0 - rho_zeta * sp2d34_1);
        ...
        //START INDEX i3=1, CENTER 3
        {
          ...
          //START INDEX i4=0, CENTER 3
          {
            ...
            //START INDEX igrad=1
            {
              scalar_type C_force_term = inv_two_eta * (p1p2p4_0 - rho_eta * p1p2p4_1);
        ...
        //START INDEX i3=2, CENTER 3
        {
          ...
          //START INDEX i4=1, CENTER 3
          {
            ...
            //START INDEX igrad=1
            {
              scalar_type C_force_term = inv_two_eta * (p1p2p3_0 - rho_eta * p1p2p3_1);
              C_force_term += WmQ[1] * p1p2d34_1;
