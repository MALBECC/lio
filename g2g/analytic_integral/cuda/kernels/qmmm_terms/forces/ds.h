{
  scalar_type F_mU[4];
  {
    ...
    lio_gamma<scalar_type, 3>(F_mU, U,gammaArray);
  }
  {
    // START INDEX i1=0, CENTER 1
    {
      ...
      // START INDEX i2=0, CENTER 1
      {
        ...
        // START INDEX igrad=0
        {
          scalar_type C_force_term = p2s_1;
          C_force_term += p1s_1;
          C_force_term *= inv_two_zeta;
          C_force_term += PmC[0] * d12s_1;
          scalar_type A_force_term = p2s_0;
          A_force_term += p1s_0;
          A_force_term *= inv_two_zeta;
          A_force_term -= C_force_term;
          scalar_type B_force_term = PmB[0] * d12s_0 + A_force_term;
          A_force_term += PmA[0] * d12s_0;
          A_force_term *= 2.0 * ai;
          B_force_term *= 2.0 * aj;
          A_force_term -= p2s_0;
          A_force_term -= p1s_0;
        ...
        // START INDEX igrad=1
        {
          scalar_type C_force_term = PmC[1] * d12s_1;
          scalar_type A_force_term = -C_force_term;
          scalar_type B_force_term = PmB[1] * d12s_0 + A_force_term;
          A_force_term += PmA[1] * d12s_0;
          A_force_term *= 2.0 * ai;
          B_force_term *= 2.0 * aj;
        ...
        // START INDEX igrad=2
        {
          scalar_type C_force_term = PmC[2] * d12s_1;
          scalar_type A_force_term = -C_force_term;
          scalar_type B_force_term = PmB[2] * d12s_0 + A_force_term;
          A_force_term += PmA[2] * d12s_0;
          A_force_term *= 2.0 * ai;
          B_force_term *= 2.0 * aj;
    ...
    // START INDEX i1=1, CENTER 1
    {
      ...
      // START INDEX i2=1, CENTER 1
      {
        ...
        // START INDEX igrad=0
        {
          scalar_type C_force_term = PmC[0] * d12s_1;
          scalar_type A_force_term = -C_force_term;
          scalar_type B_force_term = PmB[0] * d12s_0 + A_force_term;
          A_force_term += PmA[0] * d12s_0;
          A_force_term *= 2.0 * ai;
