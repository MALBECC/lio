...
__global__ void gpu_coulomb_fock( uint num_terms, vec_type<scalar_type,2>* ac_values, uint* func2nuc, uint* func_code, uint* local_fock_ind,
                                    double* fock, uint global_stride, vec_type<scalar_type,2>* ac_values_dens, vec_type<scalar_type,3>* nuc_pos_dens,
...
__global__ void gpu_coulomb_fock_reduce( double* fock, scalar_type* dens, double* energies, uint stride, uint depth, uint width )
{
