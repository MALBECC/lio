...
{
   switch(iexch) {
      case 0: return calc_ggaCS<scalar_type, 0>(dens, grad, hess1, hess2, ex, ec, y2a);
      case 1: return calc_ggaCS<scalar_type, 1>(dens, grad, hess1, hess2, ex, ec, y2a);
      case 2: return calc_ggaCS<scalar_type, 2>(dens, grad, hess1, hess2, ex, ec, y2a);
      case 3: return calc_ggaCS<scalar_type, 3>(dens, grad, hess1, hess2, ex, ec, y2a);
      case 4: return calc_ggaCS<scalar_type, 4>(dens, grad, hess1, hess2, ex, ec, y2a);
      case 5: return calc_ggaCS<scalar_type, 5>(dens, grad, hess1, hess2, ex, ec, y2a);
      case 6: return calc_ggaCS<scalar_type, 6>(dens, grad, hess1, hess2, ex, ec, y2a);
      case 7: return calc_ggaCS<scalar_type, 7>(dens, grad, hess1, hess2, ex, ec, y2a);
      case 8: return calc_ggaCS<scalar_type, 8>(dens, grad, hess1, hess2, ex, ec, y2a);
      case 9: return calc_ggaCS<scalar_type, 9>(dens, grad, hess1, hess2, ex, ec, y2a);
