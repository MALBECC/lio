                 ...
                 scalar_type& vcpbe_a,  scalar_type& vcpbe_b )
{
  ...
  //--------------------------------------------------------------*/
   ...
   scalar_type alpha   = ((scalar_type)9.0f * (scalar_type)EASYPBE_PI)
                       / (scalar_type)4.0f;
   ...
   scalar_type num = (dgrad_a * dgrad_a) - (dgrad_b * dgrad_b)
                   - (zet * dgrad * dgrad);
   ...
   pbeOS_corr<scalar_type>(rho, rs, zet, t, uu, vv, ww,
                           ec, vc_a, vc_b, h, dvc_a, dvc_b);
