...
c test of penalty function ------------------------------------
      f1=d(1,2)-2.89D0
      f2=4.0D0*0.0D0*f1
      ff(1,1)=ff(1,1)+f2*(r(1,1)-r(2,1))
      ff(1,2)=ff(1,2)+f2*(r(1,2)-r(2,2))
      ff(1,3)=ff(1,3)+f2*(r(1,3)-r(2,3))
c
      ff(2,1)=ff(2,1)-f2*(r(1,1)-r(2,1))
      ff(2,2)=ff(2,2)-f2*(r(1,2)-r(2,2))
      ff(2,3)=ff(2,3)-f2*(r(1,3)-r(2,3))
c
c----------------------------------------------------------------
      return
      end
