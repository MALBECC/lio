...
subroutine td_integral_1e(E1, En, E1s, Ens, MM, igpu, nsol, RMM, Fmat, RMM11,  &
   ...
   double precision, intent(inout) :: Fmat(MM), RMM11(MM), E1, En, E1s, Ens
   ...
   call int1(En, Fmat, RMM11, Smat, d, r, Iz, natom, ntatom)
