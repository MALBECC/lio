...
use basis_data, only: Md
   ...
   ind = 1
   do ii=1,M
      E_vec(ind) = rhoExc(ii,ii)
      D_vec(ind) = rhoDif(ii,ii) * 2.0D0
      X_vec(ind) = Xmat(ii,ii) * 2.0D0
      ind = ind + 1
      do jj=ii+1,M
   ...
   call varcoef_calc(E_vec,D_vec,X_vec,af_Exc,af_Dif,af_X, &
                     Ginv_vec, MM, MMd, Md)
   ...
   deallocate(af_Exc,af_Dif,af_X,E_vec,D_vec,X_vec)
end subroutine COUgradcalc
...
use basis_data   , only: NORM, nshelld, ad, Nucd, ncontd, cd
...
use constants_mod, only: pi5
   ...
   do jfunct = 1, ifunct
      ...
      do ncj = 1, ncontd(jfunct)
         ...
         ccoef = - cd(ifunct,nci) * cd(jfunct,ncj) * f1 * &
                ( afE(ifunct)*afE(jfunct) - afD(ifunct)*afD(jfunct) + 2.0D0*afX(ifunct)*afX(jfunct) )
         do l1 = 1, 3
   ...
   do jfunct = 1    , nsd
      ...
      do ncj = 1, ncontd(jfunct)
         ...
         do l1 = 1, 3
            ...
            ccoef2 = - ccoef * ( afE(jfunct)*afE(ifunct+l1-1) - &
                    afD(jfunct)*afD(ifunct+l1-1) + 2.0D0*afX(jfunct)*afX(ifunct+l1-1) )
         ...
         do ncj = 1, ncontd(jfunct)
            ...
            do l1 = 1, 3
               ...
               do l2 = 1, lij
                  ...
                  ccoef2 = - f1 * ccoef * ( afE(af_i)*afE(af_j) - afD(af_i)*afD(af_j) + 2.0D0*afX(af_i)*afX(af_j) )
      ...
      do ncj = 1, ncontd(jfunct)
         ...
         do l1 = 1, 3
            ...
            do l2 = 1, l1
               ...
               ccoef2 = - (ccoef / f1 ) * ( afE(ifunct + Ll(l1) + l2 - 1)*afE(jfunct) - &
                        afD(ifunct + Ll(l1) + l2 - 1)*afD(jfunct) + &
                        2.0D0*afX(ifunct + Ll(l1) + l2 - 1)*afX(jfunct) )
         ...
         do l1 = 1, 3
            ...
            do l2 = 1, l1
               ...
               do l3 = 1, 3
                  ...
                  !         ccoef/ f1
                  ccoef2 = - (ccoef/f1) * ( afE(ifunct + Ll(l1) + l2 -1)*afE(jfunct + l3 -1) - &
                          afD(ifunct + Ll(l1) + l2 -1)*afD(jfunct + l3 -1) + &
                          2.0D0*afX(ifunct + Ll(l1) + l2 -1)*afX(jfunct + l3 -1) )
                  cci    = 2.0D0 * ccoef2 * ad(ifunct,nci)
                  ccj    = 2.0D0 * ccoef2 * ad(jfunct,ncj)
                  ...
                  do l2 = 1, l1
                     ...
                     do l3 = 1, lij
                        ...
                        do l4 = 1, lk
                           ...
                           !         (f1 * f2)
                           ccoef2 = - ccoef2 * (ccoef/(f1*f2)) * ( afE(af_i)*afE(af_j) - &
                                    afD(af_i)*afD(af_j) + 2.0D0*afX(af_i)*afX(af_j) )
                           cci = 2.0D0 * ccoef2 * ad(ifunct,nci)
                           ccj = 2.0D0 * ccoef2 * ad(jfunct,ncj)
  ...
  return
end subroutine int2GExc


subroutine int3GExc(afE,afD,afX,Evec,Dvec,Xvec,frc,natom,Md,MM)
use liosubs_math , only: FUNCT
use basis_data   , only: a, c, nuc, nucd, ad, cd, ncont, ncontd, nshell, &
                         nshelld, M, NORM, rmax
use garcha_mod   , only: r, d
         ...
         if (rexp .lt. rmax) then
            ...
            do kfunct = 1, nsd
               ...
               do nck = 1, ncontd(kfunct)
                  ...
                  te = ccoef * ( afE(kfunct)*Evec(rho_ind) - afD(kfunct)*Dvec(rho_ind) + &
                                 2.0D0*afX(kfunct)*Xvec(rho_ind) )
                  ty = 2.D0  * te
                  do l1 = 1, 3
            ...
            do kfunct = 1, nsd
               ...
               do nck = 1, ncontd(kfunct)
                  ...
                  do l1 = 1, 3
                     ...
                     ty = ccoef * ( afE(kfunct)*Evec(rho_ind) - afD(kfunct)*Dvec(rho_ind) + &
                                 2.0D0*afX(kfunct)*Xvec(rho_ind) )
                     te = 2.D0  * ty
                     do l2 = 1, 3
               ...
               do nck = 1, ncontd(kfunct)
                  ...
                  do l1 = 1, 3
                     ...
                     do l2 = 1, l1
                        ...
                        te = (ccoef/f1) * ( afE(kfunct)*Evec(rho_ind) - afD(kfunct)*Dvec(rho_ind) + &
                             2.0D0*afX(kfunct)*Xvec(rho_ind) )
                        ty = 2.D0 * te
                        do l3 = 1, 3
                  ...
                  do l1 = 1, 3
                     ...
                     do l2 = 1, l1
                        ...
                        do l3 = 1, 3
                           ...
                           te = (ccoef/f1) * ( afE(kfunct)*Evec(rho_ind) - &
                               afD(kfunct)*Dvec(rho_ind) + 2.0D0*afX(kfunct)*Xvec(rho_ind) )
                           ty = 2.D0 * te
                           do l4 = 1, 3
                     ...
                     do l2 = 1, l1
                        ...
                        do l3 = 1, lij
                           ...
                           do l4 = 1, lk
                              ...
                              te = (ccoef/(f1*f2)) * ( afE(kfunct)*Evec(rho_ind) - &
                                   afD(kfunct)*Dvec(rho_ind) + 2.0D0*afX(kfunct)*Xvec(rho_ind) )
                              ty = 2.D0 * te
                              do l5 = 1, 3
            ...
            do kfunct = nsd+1, nsd+npd, 3
               ...
               do nck = 1, ncontd(kfunct)
                  ...
                  do l1 = 1, 3
                     ...
                     te = ccoef * ( afE(af_ind)*Evec(rho_ind) - &
                          afD(af_ind)*Dvec(rho_ind) + 2.0D0*afX(af_ind)*Xvec(rho_ind) )
                     ty = 2.D0*te
                     do l2 = 1, 3
                  ...
                  do l1 = 1, 3
                     ...
                     do l2 = 1, l1
                        ...
                        do l3 = 1, 3
                           ...
                           te = (ccoef/f1) * ( afE(af_ind)*Evec(rho_ind) - &
                                afD(af_ind)*Dvec(rho_ind) + 2.0D0*afX(af_ind)*Xvec(rho_ind) )
                           ty = 2.0D0 * te
                        ...
                        do l3 = 1, lij
                           ...
                           do l4 = 1, lk
                              ...
                              do l5 = 1, 3
                                 ...
                                 !    / (f1 * f2)
                                 te = (ccoef/(f1*f2)) * ( afE(af_ind)*Evec(rho_ind) - &
                                      afD(af_ind)*Dvec(rho_ind) + 2.0D0*afX(af_ind)*Xvec(rho_ind) )
                                 ty = 2.0D0 * te
                                 do l6 = 1, 3
                           ...
                           do l4 = 1, lk
                              ...
                              do l5 = 1, 3
                                 ...
                                 do l6 = 1, l5
                                    ...
                                    !te = af(af_ind) * rho_mat(rho_ind) * ccoef/&
                                    !     (f1 * f2 * f3)
                                    te = (ccoef/(f1*f2*f3)) * ( afE(af_ind)*Evec(rho_ind) - &
                                         afD(af_ind)*Dvec(rho_ind) + 2.0D0*afX(af_ind)*Xvec(rho_ind) )
                                    ty = 2.0D0 * te
