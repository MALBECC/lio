                     ...
                     do nck = 1, ncontd(kfunct)
                        ...
                        do l1 = 1, 3
                           ...
                           do l2 = 1, 3
                              ...
                              spp = psp+tx*ssp
                              frc(Nuc(ifunct),l2) = frc(Nuc(ifunct),l2)+a(ifunct,nci)*(ty+tw)*psp
                              frc(Nuc(jfunct),l2) = frc(Nuc(jfunct),l2)+a(jfunct,ncj)*(ty+tw)*spp
                              frc(Nucd(kfunct),l2) = frc(Nucd(kfunct),l2)+ad(kfunct,nck) * ty * ssd
                           enddo
                        enddo
                     enddo
                  enddo
                           ...
                           do l2 = 1, 3
                              ...
                              do l3 = 1, 3
                                 ...
                                 if (l1 .eq. l3) then
                                    psd = psd + t4
                                    dsp = dsp + t10
                                    frc(Nuc(ifunct),l3) = frc(Nuc(ifunct),l3) - te * ss0pj
                                 endif
                                 if (l2 .eq. l3) then
                                    psd = psd + t5
                                    dsp = dsp+t9
                                    frc(Nucd(kfunct),l3) = frc(Nucd(kfunct),l3) - te * ps
                                 endif
                                 ppp = dsp+tx*pi0spj
                                 frc(Nuc(ifunct),l3) = frc(Nuc(ifunct),l3)+a(ifunct,nci) * ty * dsp
                                 frc(Nuc(jfunct),l3) = frc(Nuc(jfunct),l3)+a(jfunct,ncj) * ty * ppp
                                 frc(Nucd(kfunct),l3) = frc(Nucd(kfunct),l3)+ad(kfunct,nck) * ty * psd
                              enddo
                           enddo
                        enddo
                     enddo
                              ...
                              do l3 = 1, 3
                                 ...
                                 do l4 = 1, 3
                                    ...
                                    if (l1 .eq. l4) then
                                       ppd = ppd+t9
                                       dpp = dpp + t15
                                       frc(Nuc(ifunct),l4) = frc(Nuc(ifunct),l4) - te * spp
                                    endif
                                    if (l2 .eq. l4) then
                                       ppd = ppd + t10
                                       dpp = dpp + t14
                                       frc(Nuc(jfunct),l4) = frc(Nuc(jfunct),l4) - te * psp
                                    endif
                                    if (l3 .eq. l4) then
                                       ppd = ppd + t11
                                       dpp = dpp + t12
                                       frc(Nucd(kfunct),l4) = frc(Nucd(kfunct),l4) - te * pijs
                                    endif
                                    pdp = dpp+tx*ppp
                                    frc(Nuc(ifunct),l4) = frc(Nuc(ifunct),l4)+a(ifunct,nci) * ty * dpp
                                    frc(Nuc(jfunct),l4) = frc(Nuc(jfunct),l4)+a(jfunct,ncj) * ty * pdp
                                    frc(Nucd(kfunct),l4) = frc(Nucd(kfunct),l4)+ad(kfunct,nck) * ty * ppd
                                 enddo
                              enddo
                           enddo
                        enddo
                              ...
                              do l3 = 1, 3
                                 ...
                                 do l4 = 1, 3
                                    ...
                                    if (l1 .eq. l4) then
                                       dpp = dpp + t10
                                       dsd=dsd + t11
                                       frc(Nuc(ifunct),l4) = frc(Nuc(ifunct),l4) - te * pj0p
                                    endif
                                    if (l2 .eq. l4) then
                                       dpp = dpp + t12
                                       dsd=dsd + t13
                                       frc(Nuc(ifunct),l4) = frc(Nuc(ifunct),l4) - te * pi0p
                                    endif
                                    if (l3 .eq. l4) then
                                       dpp = dpp + t14
                                       dsd=dsd + t15
                                       frc(Nucd(kfunct),l4) = frc(Nucd(kfunct),l4) - te * d0s
                                    endif
                                    fsp = dpp-tx*dsp
                                    frc(Nuc(ifunct),l4) = frc(Nuc(ifunct),l4)+ty*a(ifunct,nci)*fsp
                                    frc(Nuc(jfunct),l4) = frc(Nuc(jfunct),l4)+ty*a(jfunct,ncj)*dpp
                                    frc(Nucd(kfunct),l4) = frc(Nucd(kfunct),l4)+ty*ad(kfunct,nck)*dsd
                                 enddo
                              enddo
                           enddo
                        enddo
                                 ...
                                 do l4 = 1, 3
                                    ...
                                    do l5 = 1, 3
                                       ...
                                       if (l1 .eq. l5) then
                                          ddp = ddp+t20
                                          dpd=dpd+t21
                                          frc(Nuc(ifunct),l5) = frc(Nuc(ifunct),l5) - te * pj0pp
                                       endif
                                       if (l2 .eq. l5) then
                                          ddp = ddp+t22
                                          dpd=dpd+t23
                                          frc(Nuc(ifunct),l5) = frc(Nuc(ifunct),l5) - te * pi0pp
                                       endif
                                       if (l3 .eq. l5) then
                                          ddp = ddp+t24
                                          dpd=dpd+t25
                                          frc(Nuc(jfunct),l5) = frc(Nuc(jfunct),l5) - te * d0pl
                                       endif
                                       if (l4 .eq. l5) then
                                          ddp = ddp+t26
                                          dpd=dpd+t27
                                          frc(Nucd(kfunct),l5) = frc(Nucd(kfunct),l5) - te * d0p
                                       endif
                                       fpp = ddp-tx*dpp
                                       frc(Nuc(ifunct),l5) = frc(Nuc(ifunct),l5)+a(ifunct,nci) * ty * fpp
                                       frc(Nuc(jfunct),l5) = frc(Nuc(jfunct),l5)+a(jfunct,ncj) * ty * ddp
                                       frc(Nucd(kfunct),l5) = frc(Nucd(kfunct),l5)+ad(kfunct,nck) * ty * dpd
                                    enddo
                                 enddo
                              enddo
                           enddo
                                    ...
                                    do l5 = 1, 3
                                       ...
                                       do l6=1,3
                                          ...
                                          if (l1 .eq. l6) then
                                             fdp=fdp+t20
                                             ddd=ddd+t21
                                             frc(Nuc(ifunct),l6) = frc(Nuc(ifunct),l6) - te * pj0dp
                                          endif
                                          if (l2 .eq. l6) then
                                             fdp=fdp+t22
                                             ddd=ddd+t23
                                             frc(Nuc(ifunct),l6) = frc(Nuc(ifunct),l6) - te * pi0dp
                                          endif
                                          if (l3 .eq. l6) then
                                             fdp=fdp+t24
                                             ddd=ddd+t25
                                             frc(Nuc(jfunct),l6) = frc(Nuc(jfunct),l6) - te * d0plp
                                          endif
                                          if (l4 .eq. l6) then
                                             fdp=fdp+t26
                                             ddd=ddd+t27
                                             frc(Nuc(jfunct),l6) = frc(Nuc(jfunct),l6) - te * d0pkp
                                          endif
                                          if (l5 .eq. l6) then
                                             fdp=fdp+t28
                                             ddd=ddd+t29
                                             frc(Nucd(kfunct),l6) = frc(Nucd(kfunct),l6) - te * d0d
                                          endif
                                          dfp=fdp+tx*ddp
                                          frc(Nuc(ifunct),l6) = frc(Nuc(ifunct),l6)+a(ifunct,nci) * ty * fdp
                                          frc(Nuc(jfunct),l6) = frc(Nuc(jfunct),l6)+a(jfunct,ncj) * ty * dfp
                                          frc(Nucd(kfunct),l6) = frc(Nucd(kfunct),l6)+ad(kfunct,nck) * ty * ddd
                                       enddo
                                    enddo
                                 enddo
                              enddo
                           ...
                           do l2 = 1, l1
                              ...
                              do l3 = 1, 3
                                 ...
                                 if (l1 .eq. l3) then
                                    ssf=ssf + t10
                                    psd = psd + t12
                                    frc(Nucd(kfunct),l3) = frc(Nucd(kfunct),l3) - te * ss0pj
                                 endif
                                 if (l2 .eq. l3) then
                                    ssf=ssf + t11
                                    psd = psd + t13
                                    frc(Nucd(kfunct),l3) = frc(Nucd(kfunct),l3) - te * ss0p
                                 endif
                                 spd = psd+tx*ss0d
                                 frc(Nuc(ifunct),l3) = frc(Nuc(ifunct),l3)+a(ifunct,nci) * ty * psd
                                 frc(Nuc(jfunct),l3) = frc(Nuc(jfunct),l3)+a(jfunct,ncj) * ty * spd
                                 frc(Nucd(kfunct),l3) = frc(Nucd(kfunct),l3)+ad(kfunct,nck) * ty * ssf
                              ...
                              do l3 = 1, l2
                                 ...
                                 do l4 = 1, 3
                                    ...
                                    if (l1 .eq. l4) then
                                       dsd=dsd + t10
                                       psf=psf + t11
                                       frc(Nuc(ifunct),l4) = frc(Nuc(ifunct),l4) - te * ss0d
                                    endif
                                    if (l2 .eq. l4) then
                                       dsd=dsd + t12
                                       psf=psf + t13
                                       frc(Nucd(kfunct),l4) = frc(Nucd(kfunct),l4) - te * p0pk
                                    endif
                                    if (l3 .eq. l4) then
                                       dsd=dsd + t14
                                       psf=psf + t15
                                       frc(Nucd(kfunct),l4) = frc(Nucd(kfunct),l4) - te * pi0spj
                                    endif
                                    ppd=dsd+tx*ps0d
                                    frc(Nuc(ifunct),l4) = frc(Nuc(ifunct),l4)+a(ifunct,nci) * ty * dsd
                                    frc(Nuc(jfunct),l4) = frc(Nuc(jfunct),l4)+a(jfunct,ncj) * ty * ppd
                                    frc(Nucd(kfunct),l4) = frc(Nucd(kfunct),l4)+ad(kfunct,nck) * ty * psf
                                 enddo
                              enddo
                           enddo
                        enddo
                                 ...
                                 do l4 = 1, l3
                                    ...
                                    do l5 = 1, 3
                                       ...
                                       if (l1 .eq. l5) then
                                          dpd=dpd+t20
                                          ppf=ppf+t21
                                          frc(Nuc(ifunct),l5) = frc(Nuc(ifunct),l5) - te * sp0d
                                       endif
                                       if (l2 .eq. l5) then
                                          dpd=dpd+t22
                                          ppf=ppf+t23
                                          frc(Nuc(jfunct),l5) = frc(Nuc(jfunct),l5) - te * ps0d
                                       endif
                                       if (l3 .eq. l5) then
                                          dpd=dpd+t24
                                          ppf=ppf+t25
                                          frc(Nucd(kfunct),l5) = frc(Nucd(kfunct),l5) - te * pp0pl
                                       endif
                                       if (l4 .eq. l5) then
                                          dpd=dpd+t26
                                          ppf=ppf+t27
                                          frc(Nucd(kfunct),l5) = frc(Nucd(kfunct),l5) - te * pp0p
                                       endif
                                       pdd=dpd+tx*pp0d
                                       frc(Nuc(ifunct),l5) = frc(Nuc(ifunct),l5)+a(ifunct,nci) * ty * dpd
                                       frc(Nuc(jfunct),l5) = frc(Nuc(jfunct),l5)+a(jfunct,ncj) * ty * pdd
                                       frc(Nucd(kfunct),l5) = frc(Nucd(kfunct),l5)+ad(kfunct,nck) * ty * ppf
                                    enddo
                                 enddo
                              enddo
                           enddo
                                 ...
                                 do l4 = 1, l3
                                    ...
                                    do l5 = 1, 3
                                       ...
                                       if (l1 .eq. l5) then
                                          dpd=dpd+t20
                                          dsf=dsf+t21
                                          frc(Nuc(ifunct),l5) = frc(Nuc(ifunct),l5) - te * pj0sd
                                       endif
                                       if (l2 .eq. l5) then
                                          dpd=dpd+t22
                                          dsf=dsf+t23
                                          frc(Nuc(ifunct),l5) = frc(Nuc(ifunct),l5) - te * pi0sd
                                       endif
                                       if (l3 .eq. l5) then
                                          dpd=dpd+t24
                                          dsf=dsf+t25
                                          frc(Nucd(kfunct),l5) = frc(Nucd(kfunct),l5) - te * d0pl
                                       endif
                                       if (l4 .eq. l5) then
                                          dpd=dpd+t26
                                          dsf=dsf+t27
                                          frc(Nucd(kfunct),l5) = frc(Nucd(kfunct),l5) - te * ds0p
                                       endif
                                       fsd=dpd-tx*dsd
                                       frc(Nuc(ifunct),l5) = frc(Nuc(ifunct),l5)+a(ifunct,nci) * ty * fsd
                                       frc(Nuc(jfunct),l5) = frc(Nuc(jfunct),l5)+a(jfunct,ncj) * ty * dpd
                                       frc(Nucd(kfunct),l5) = frc(Nucd(kfunct),l5)+ad(kfunct,nck) * ty * dsf
                                    enddo
                                 enddo
                              enddo
                           enddo
                                       ...
                                       do l6=1,l5
                                          ...
                                          do l7=1,3
                                             ...
                                             if (l1 .eq. l7) then
                                                fdd=fdd+y20
                                                ddf=ddf+y21
                                                frc(Nuc(ifunct),l7) = frc(Nuc(ifunct),l7) - te * pj0dd
                                             endif
                                             if (l2 .eq. l7) then
                                                fdd=fdd+y22
                                                ddf=ddf+y23
                                                frc(Nuc(ifunct),l7) = frc(Nuc(ifunct),l7) - te * pi0dd
                                             endif
                                             if (l3 .eq. l7) then
                                                fdd=fdd+y24
                                                ddf=ddf+y25
                                                frc(Nuc(jfunct),l7) = frc(Nuc(jfunct),l7) - te * d0pld
                                             endif
                                             if (l4 .eq. l7) then
                                                fdd=fdd+y26
                                                ddf=ddf+y27
                                                frc(Nuc(jfunct),l7) = frc(Nuc(jfunct),l7) - te * d0pkd
                                             endif
                                             if (l5 .eq. l7) then
                                                fdd=fdd+y28
                                                ddf=ddf+y29
                                                frc(Nucd(kfunct),l7) = frc(Nucd(kfunct),l7) - te * dd0pn
                                             endif
                                             if (l6 .eq. l7) then
                                                fdd=fdd+y30
                                                ddf=ddf+y31
                                                frc(Nucd(kfunct),l7) = frc(Nucd(kfunct),l7) - te * dd0p
                                             endif
                                             dfd=fdd+tx*ddd
                                             frc(Nuc(ifunct),l7) = frc(Nuc(ifunct),l7)+a(ifunct,nci) * ty * fdd
                                             frc(Nuc(jfunct),l7) = frc(Nuc(jfunct),l7)+a(jfunct,ncj) * ty * dfd
                                             frc(Nucd(kfunct),l7) = frc(Nucd(kfunct),l7)+ad(kfunct,nck) * ty * ddf
