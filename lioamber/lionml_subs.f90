...
subroutine lionml_write_dull()
   ...
   write(*,8045) inputs%td_do_opop, inputs%td_rho_purify
...
8044 FORMAT(2x,"field_aniso_file = ", A25, ", td_do_pop = ", I5,               &
            ", td_eu_step = ", I5)
8045 FORMAT(2x,"td_do_opop = ", I5, ", td_rho_purify = ", I3)
! ECP
...
8141 FORMAT(2x, "gate_field = ", L2, ", pop_drive = ", I3, &
            ", save_charge_freq = ", I5, ", TBDFT_calc = ", I5, ",")
...
8456 FORMAT(4x,"║  tbdft_calc          ║  ",18x,I5,2x,"║")
