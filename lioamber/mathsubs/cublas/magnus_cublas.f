!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%!
       SUBROUTINE magnus_cublas_dz(Fock,RhoOld,RhoNew,M,N,dt,factorial)
!------------------------------------------------------------------------------!
...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%!
       ...
       EXTERNAL CUBLAS_CAXPY,CUBLAS_ZCOPY 
...
!=======================================!
!       stat= CUBLAS_SET_MATRIX(M,M,sizeof_complex,RhoOld,M,devPNext,M)
...
!=======================================!
      ...
      if (stat.NE.0) then
      write(*,*) "ZCOPY failed -cumagnusfac/2"
      call CUBLAS_FREE ( devPOmega )
      call CUBLAS_FREE ( devPRho )
      call CUBLAS_FREE ( devPNext )
      call CUBLAS_FREE ( devPPrev )
...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%!
       SUBROUTINE magnus_cublas_dc(Fock,RhoOld,RhoNew,M,N,dt,factorial)
!------------------------------------------------------------------------------!
! Propagador basado en la formula de Baker-Campbell-Hausdorff de orden N.
! Entrada: Fock(t+(deltat/2)), rho(t)
! Salida:  rho6=rho(t+deltat)
