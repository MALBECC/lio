...
c        betaex=btexxx+btexyy+btexzz
c        betaey=bteyyy+bteyxx+bteyzz
c        betaez=btezzz+btezxx+btezyy
c        betae=(betaex**2+betaey**2+betaez**2)**0.5D0 
c        betaux=btuxxx+btuxyy+btuxzz
c        betauy=btuyyy+btuyxx+btuyzz
c        betauz=btuzzz+btuzxx+btuzyy
c        betau=(betaux**2+betauy**2+betauz**2)**0.5D0 
c        gammae=0.2D0*(gmex+gmez+gmey+2D0*(gmezzxx+
c    >          gmezzyy+gmeyyxx))
c        gammau=0.2D0*(gmux+gmuz+gmuy+2D0*(gmuzzxx+
c    >          gmuzzyy+gmuyyxx))
c        sumbet=suma-(betaex+betaey+betaez)
c ---------------------------------------------------------------
...
c      write(*,900) btexxx,bteyyy,btezzz
c      write(*,950) gmex,gmey,gmez
       write(*,*) 
       write(*,*) 'RESULTS OBTAINED USING DIPOLE EXPANSION'
       write(*,800) alphaux,alphauy,alphauz
c      write(*,900) btuxxx,btuyyy,btuzzz
c      write(*,950) gmux,gmuy,gmuz
c      write(*,*)
c      write(*,*)  'NON DIAGONAL TERMS'
c      write(*,*)
c      write(*,*) 'RESULTS OBTAINED USING ENERGY EXPANSION' 
c      write(*,*) 'Alpha xy   Alpha xz'
c      write(*,910) alpexy,alpexz
c      write(*,*) 'Alpha yx   Alpha yz'
c      write(*,910) alpeyx,alpeyz
c      write(*,*) 'Alpha zx   Alpha zy'
c      write(*,910) alpezx,alpezy
c      write(*,*) 'Beta xyy   Betaxzz'
c      write(*,910) btexyy,btexzz
c      write(*,*) 'Beta yxx   Betayzz'
c      write(*,910) bteyxx,bteyzz   
c      write(*,*) 'Beta zxx   Betazyy'
c      write(*,910) btezxx,btezyy 
c      write(*,*) 'Gammaxxyy       Gammaxxzz'
c      write(*,*) gmexxyy,gmexxzz
c      write(*,*) 'Gammayyxx       Gammayyzz'
c      write(*,*) gmeyyxx,gmeyyzz
c      write(*,*) 'Gammazzxx       Gammazzyy'
c      write(*,*) gmezzxx,gmezzyy
c      write(*,*)
c      write(*,*) 'RESULTS OBTAINED USING DIPOLE EXPANSION' 
c      write(*,*) 'Alpha xy   Alpha xz'
c      write(*,910) alpuxy,alpuxz
c      write(*,*) 'Alpha yx   Alpha yz'
c      write(*,910) alpuyx,alpuyz
c      write(*,*) 'Alpha zx   Alpha zy'
c      write(*,910) alpuzx,alpuzy
c      write(*,*) 'Beta xyy   Betaxzz'
c      write(*,910) btuxyy,btuxzz
c      write(*,*) 'Beta yxx   Betayzz' 
c      write(*,910) btuyxx,btuyzz   
c      write(*,*) 'Beta zxx   Betazyy' 
c      write(*,910) btuzxx,btuzyy
c      write(*,*) 'Gammaxxyy       Gammaxxzz'
c      write(*,*) gmuxxyy,gmuxxzz
c      write(*,*) 'Gammayyxx       Gammayyzz'
c      write(*,*) gmuyyxx,gmuyyzz
c      write(*,*) 'Gammazzxx       Gammazzyy'
c      write(*,*) gmuzzxx,gmuzzyy
       write(*,*) 'OBSERVABLES'
       write(*,*) 'RESULTS OBTAINED USING ENERGY EXPANSION'
       write(*,940) alphae
c      write(*,*) 'Beta x   Beta y   Beta z'
c      write(*,820) betaex,betaey,betaez
c      write(*,960) Sumbet
c      write(*,930) betae
c      write(*,920) gammae
       write(*,*) 'RESULTS OBTAINED USING DIPOLE EXPANSION'
       write(*,940) alphau
c      write(*,*) 'Beta x   Beta y   Beta z'
c      write(*,820) betaux,betauy,betauz
c      write(*,930) betau
c      write(*,920) gammau
c---------
 700   format('DIPOLE MOMENT =',3(1x,F7.4))
 800   format('POLARIZABILITY =',3(1x,F10.4))
